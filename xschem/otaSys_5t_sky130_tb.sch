...
B 2 550 -310 1350 90 {flags=graph
y1=0.0038
y2=12
ypos1=0
ypos2=2
...
logx=0
logy=0
rawfile=$netlist_dir/otaSys_5t_sky130_tb_ac_noQboost.raw}
N -1080 60 -950 60 {lab=v3}
N -850 60 -770 60 {lab=out}
C {gnd.sym} -1050 260 0 0 {name=l9 lab=0
spice_ignore=true}
...
op
print @m.x1.x4.xm2.msky130_fd_pr__nfet_01v8[id] @m.x1.x4.xm4.msky130_fd_pr__pfet_01v8[id]
write otaSys_5t_sky130_tb_op.raw
ac dec 20 1 100meg
write otaSys_5t_sky130_tb_ac.raw
.endc"
}
C {bsource.sym} -1050 230 0 0 {name=B1 VAR=V FUNC="'0.89375+0.1*sin(2*pi*f*floor(time/Ts)*Ts)'" m=1
spice_ignore=true}
C {vsource.sym} -1050 90 0 0 {name=V3 value="dc 0.89375 ac 1" savecurrent=false}
C {gnd.sym} -1050 120 0 0 {name=l10 lab=0}
