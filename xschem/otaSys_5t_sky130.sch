...
spiceprefix=X
mult=1}
C {sky130_fd_pr/cap_mim_m3_1.sym} 180 260 0 0 {name=C2 model=cap_mim_m3_1 W=24 L=24 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 80 260 0 0 {name=C3 model=cap_mim_m3_1 W=24 L=24 MF=1 spiceprefix=X}
